        ...
        try:
            ...
            if sim_df is not None:
                ...
                try:
                    ...
                    state_out.update(CP.PT_INPUTS, P_ATM, self.user_inputs['T0_k'])
                    c_sound = state_out.speed_sound()
                    rho_out = state_out.rhomass()
                    W_avg_kg_s = (mdot_max + mdot_son) / 2.0 / 3600.0
                    v_out = W_avg_kg_s / (rho_out * A_valve_m2)
                    mach_avg = v_out / c_sound
                except:
                    mach_avg = 0.0
                ...
                self.results_text.insert(tk.END, f"  * Çıkış Hattı Ort. Mach Sayısı   : {mach_avg:.2f} Mach\n")
