...
def size_steam_area_api520(
    *,
    ...
    try:
        ...
        return steam_from_gas_fallback(
            "Steam service relieving pressure exceeds critical point; API 520 steam Napier denklemi yerine gas/vapor fallback sizing kullanildi."
        )
    ...
    try:
        ...
        return steam_from_gas_fallback(
            "Steam service Napier KN correction exceeds valid pressure range; gas/vapor fallback sizing kullanildi.",
            kn_used=None,
        )
    if superheat_c <= 1.0:
        ksh = 1.0
